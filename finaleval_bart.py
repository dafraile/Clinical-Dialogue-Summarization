...
tokenizer = AutoTokenizer.from_pretrained("/tmp/tst-summarization")

model = AutoModelForSeq2SeqLM.from_pretrained("/tmp/tst-summarization")
...
path2 = "/home/ubuntu/transformers/data/eval_conv_7.csv"
...
print(out_df)
out_df.to_csv('finalqualeval_bartcnnsamsum.csv')